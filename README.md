...
별도 폴더에 보관합니다. 도구를 업데이트해도 프로젝트 보관 폴더는
수정되지 않습니다.
...
```
- 자동화 적용 전 버전을 사용 중이라면 기존 프로젝트를 그대로 두고
...
도구 업데이트와 프로젝트 구조 갱신은 분리됩니다. 먼저 변경 예정
내용을 확인하세요.
...
<big><strong>자세한 문서 요소, 운영 규칙, 유지보수 기준, 다른 에이전트
로컬라이징 관련 정보는 [OPERATING_GUIDE.md](OPERATING_GUIDE.md)를
확인하세요.</strong></big>
